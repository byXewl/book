...
国内重构版Neo-reGeorg：<https://github.com/L-codes/Neo-reGeorg>
```shell
...
### 测试
![](.topwrite/assets/image_1756720695358.png)
...
^
## **suo5正向代理**
suo5是一个高性能 HTTP 隧道代理工具（socks5），它基于双向的 Chunked-Encoding构建, 相比 [Neo-reGeorg](https://github.com/L-codes/Neo-reGeorg) 等传统隧道工具, suo5 的性能可以达到其数十倍。但是目前apache的php必须用Neo-reGeorg。
![](.topwrite/assets/image_1758282499806.png)
官方：
...
本地端也有GUI：
![](.topwrite/assets/image_1756723061176.png)
