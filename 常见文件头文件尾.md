...
一个文件如图片中默尾有多出的16进制9E97BA2A，就是OurSecret加密特征，具体见图像隐写中的OurSecret加密特征


mp4，文件头：前四个字节表示文件头大小 后四个字节固定位66 74 79 70 ftyp
文件头格式为00 00 00 20 66 74 79 70 69 73 6F 6D，文件尾格式为00 00 00
```
